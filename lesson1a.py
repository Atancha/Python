# What is a variable: Variable they are labels which act as containers to hold values.In python,a variable is always associated with some values.
...
#variable names are not supposed to be keyword/ reserved characters in python
#for = "Nairobi"
#print(for)
